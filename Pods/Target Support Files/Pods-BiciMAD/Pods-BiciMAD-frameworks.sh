...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ARFacebookShareKitActivity/ARFacebookShareKitActivity.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CMMapLauncher/CMMapLauncher.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DTMHeatmap/DTMHeatmap.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FBNotifications/FBNotifications.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FBSDKCoreKit/FBSDKCoreKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FBSDKShareKit/FBSDKShareKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FXNotifications/FXNotifications.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SFDraggableDialogView/SFDraggableDialogView.framework"
